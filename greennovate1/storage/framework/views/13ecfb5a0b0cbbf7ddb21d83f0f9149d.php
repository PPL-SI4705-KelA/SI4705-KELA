                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-5 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="<?php echo e(route('kegiatan.show', $kegiatan->slug)); ?>" class="inline-flex items-center gap-1.5 px-3.5 py-2 text-[12px] font-semibold text-[#1a8245] border border-green-200 rounded-lg hover:bg-green-50 transition-colors min-h-[36px]">
                                    ...
                                    <?php if(in_array($kegiatan->status, ['Berlangsung', 'Persiapan'])): ?>
                                        <a href="<?php echo e(route('petugas.realisasi', ['kegiatan_id' => $kegiatan->id])); ?>" class="inline-flex items-center gap-1.5 px-3.5 py-2 text-[12px] font-semibold text-white bg-[#1a8245] hover:bg-green-800 rounded-lg transition-colors min-h-[36px]">
                                            Catat
                                        </a>
                                    <?php endif; ?>
                                </div>
...
<?php echo $__env->make('layouts.petugas', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\egiag\Downloads\Gabungan\greennovate_final\resources\views/petugas/semua-kegiatan.blade.php ENDPATH**/ ?>