...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo $__env->yieldContent('title', 'Greennovate – Bersama Menghijaukan Bumi'); ?></title>
            ...
            <div class="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center gap-7 text-sm font-medium">
                    <a href="/" id="nav-beranda"
                       class="<?php echo e(request()->is('/') ? 'text-[#0D8B41] font-semibold' : 'text-gray-500 hover:text-[#0D8B41]'); ?> transition-colors">
                        Beranda
                    </a>
        
                    <a href="<?php echo e(route('kegiatan.index')); ?>" id="nav-kegiatan"
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->user()->role === 'admin'): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-gray-500 hover:text-[#0D8B41] transition-colors font-medium">Dashboard Admin</a>
                        <?php elseif(auth()->user()->role === 'petugas'): ?>
                            <a href="<?php echo e(route('petugas.dashboard')); ?>" class="text-gray-500 hover:text-[#0D8B41] transition-colors font-medium">Dashboard Petugas</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
                ...
                <div class="flex items-center gap-2">
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('login')); ?>" id="nav-login-btn"
                           class="text-sm font-semibold text-gray-600 hover:text-[#0D8B41] transition-colors px-3 py-1.5">
                            Masuk
                        </a>
                        <a href="<?php echo e(route('register')); ?>" id="nav-register-btn"
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('donations.index')); ?>" id="nav-donasi-link"
                           class="flex items-center gap-1.5 text-sm font-medium <?php echo e(request()->routeIs('donations.*') ? 'text-[#0D8B41] font-semibold' : 'text-gray-500 hover:text-[#0D8B41]'); ?> transition-colors px-2 py-1.5">
                        ...
                        class="flex items-center gap-1.5 text-sm font-medium <?php echo e(request()->routeIs('pembelian.*') ? 'text-[#0D8B41] font-semibold' : 'text-gray-500 hover:text-[#0D8B41]'); ?> transition-colors px-2 py-1.5">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <a href="<?php echo e(route('riwayat.index')); ?>" id="nav-riwayat-link"
                        ...
                        <a href="<?php echo e(auth()->user()->role === 'admin' ? route('admin.dashboard') : (auth()->user()->role === 'petugas' ? route('petugas.dashboard') : route('dashboard'))); ?>" id="nav-user-pill"
        ...
        <footer class="bg-[#0a1f14] text-white">
            <div class="max-w-6xl mx-auto px-6 py-16">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2.5">
                            ...
                            <li><a href="<?php echo e(route('register')); ?>" class="text-gray-400 hover:text-white text-sm transition-colors">Daftar</a></li>
                        </ul>
                    </div>
                ...
                <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p class="text-gray-500 text-sm">© <?php echo e(date('Y')); ?> Greennovate. Dibuat dengan ❤️ untuk bumi yang lebih hijau.</p>
...
</html><?php /**PATH C:\Users\egiag\Downloads\Gabungan\greennovate_final\resources\views/layouts/landing.blade.php ENDPATH**/ ?>