<?php $__env->startSection('title', 'Riwayat Partisipasi - Greennovate'); ?>
...
<div class="pt-24 pb-16 max-w-5xl mx-auto px-6">
    ...
    <div class="flex flex-wrap gap-2 mb-6">
        <a href="<?php echo e(route('riwayat.index')); ?>" class="filter-btn <?php echo e(!$filterTipe ? 'active' : ''); ?>">Semua</a>
        <a href="<?php echo e(route('riwayat.index', ['tipe' => 'donasi'])); ?>" class="filter-btn <?php echo e($filterTipe === 'donasi' ? 'active' : ''); ?>">💝 Donasi</a>
        <a href="<?php echo e(route('riwayat.index', ['tipe' => 'pembelian'])); ?>" class="filter-btn <?php echo e($filterTipe === 'pembelian' ? 'active' : ''); ?>">🛒 Pembelian</a>
        <a href="<?php echo e(route('riwayat.index', ['tipe' => 'kegiatan'])); ?>" class="filter-btn <?php echo e($filterTipe === 'kegiatan' ? 'active' : ''); ?>">🌱 Kegiatan</a>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <div class="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
            ...
            <p class="text-2xl font-bold text-gray-900"><?php echo e($riwayatItems->total()); ?></p>
        </div>
        <div class="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Filter Aktif</p>
            <p class="text-2xl font-bold text-[#0D8B41]"><?php echo e($filterTipe ? ucfirst($filterTipe) : 'Semua'); ?></p>
        </div>
        <div class="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Halaman</p>
            <p class="text-2xl font-bold text-gray-900"><?php echo e($riwayatItems->currentPage()); ?> / <?php echo e($riwayatItems->lastPage()); ?></p>
        </div>
    </div>

    
    <?php if($riwayatItems->count() > 0): ?>
        <div class="space-y-3" id="riwayat-list">
            <?php $__currentLoopData = $riwayatItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="riwayat-card bg-white rounded-xl border border-gray-100 p-5 shadow-sm flex items-center justify-between gap-4"
                     onclick="openDetail('<?php echo e($item['tipe']); ?>', <?php echo e($item['id']); ?>)"
                     id="riwayat-item-<?php echo e($item['tipe']); ?>-<?php echo e($item['id']); ?>">
                    <div class="flex items-center gap-4 flex-1 min-w-0">
                        
                        <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0
                            <?php echo e($item['tipe'] === 'donasi' ? 'bg-rose-100' : ($item['tipe'] === 'pembelian' ? 'bg-blue-100' : 'bg-green-100')); ?>">
                            <?php if($item['tipe'] === 'donasi'): ?>
                            ...
                            <?php elseif($item['tipe'] === 'pembelian'): ?>
                        ...
                        <div class="min-w-0 flex-1">
                            <p class="font-semibold text-gray-900 truncate"><?php echo e($item['nama']); ?></p>
                            <div class="flex items-center gap-3 text-xs text-gray-400 mt-1">
                                <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold badge-<?php echo e($item['tipe_color']); ?>"><?php echo e($item['tipe_label']); ?></span>
                                <span><?php echo e($item['tanggal']->translatedFormat('d M Y')); ?></span>
                                <span class="hidden sm:inline text-gray-300">•</span>
                                <span class="hidden sm:inline"><?php echo e($item['kode']); ?></span>
                            </div>
                        </div>
                    </div>
                    
                    <div class="flex items-center gap-3 flex-shrink-0">
                        <span class="text-xs font-bold text-gray-500 hidden sm:block"><?php echo e($item['detail']); ?></span>
                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold badge-<?php echo e($item['status_color']); ?>">
    ...
    <?php else: ?>
        <div class="empty-state bg-white rounded-xl border border-gray-100 shadow-sm">
            ...
            <a href="<?php echo e(route('kegiatan.index')); ?>" class="inline-flex items-center gap-2 mt-4 px-5 py-2.5 bg-[#0D8B41] text-white text-sm font-semibold rounded-full hover:bg-[#085c2b] transition">
                Jelajahi Kegiatan
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PPL-SI4705-KelA\greennovate\SI4705-KELA-main\greennovate\resources\views/riwayat/index.blade.php ENDPATH**/ ?>