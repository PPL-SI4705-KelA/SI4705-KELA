...
<div class="w-full max-w-5xl px-6 mt-4 pb-16">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                <?php if(auth()->check() && (auth()->user()->isPetugas() || auth()->user()->isAdmin())): ?>
                    ...
                    <div class="flex items-start gap-3 p-4 bg-blue-50 rounded-xl border border-blue-100">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-blue-700">
                                <?php echo e(auth()->user()->isPetugas() ? 'Anda adalah Petugas Lapangan' : 'Anda adalah Administrator'); ?>
                ...
                <?php elseif($kegiatan->isRegistrationOpen()): ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\egiag\Downloads\Gabungan\greennovate_final\resources\views/kegiatan/show.blade.php ENDPATH**/ ?>