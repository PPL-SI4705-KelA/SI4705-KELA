    ...
    <div class="mb-6 bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8">
        <div class="flex flex-col sm:flex-row items-center sm:items-start gap-5">
            ...
            <div class="flex-1 text-center sm:text-left">
                ...
                <p class="text-gray-500 text-sm mt-0.5"><?php echo e($user->email); ?></p>
                <div class="flex flex-wrap justify-center sm:justify-start gap-2 mt-3">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold <?php echo e($user->is_active ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'); ?>">
            ...
            <div class="text-center sm:text-right text-xs text-gray-400 flex-shrink-0">
                <p><?php echo e(__('Member Since')); ?></p>
                <p class="font-semibold text-gray-600"><?php echo e($user->created_at->format('d M Y')); ?></p>
            </div>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <label for="city" class="block text-sm font-medium text-gray-700 mb-1.5"><?php echo e(__('City')); ?></label>
                    <input id="city" type="text" name="city" value="<?php echo e(old('city', $user->city)); ?>"
                        placeholder="<?php echo e(__('Enter your city')); ?>"
                        class="w-full px-4 py-2.5 border rounded-xl focus:ring-2 focus:ring-green-500/20 focus:border-green-500 outline-none transition text-sm
                        <?php echo e($errors->has('city') ? 'border-red-400 bg-red-50/50' : 'border-gray-300'); ?>">
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class="p-4 rounded-xl bg-gray-50 border border-gray-100">
                        <p class="text-xs text-gray-500 mb-1"><?php echo e(__('Role')); ?></p>
                        <p class="text-sm font-semibold text-gray-900"><?php echo e(__('role_' . $user->role)); ?></p>
                    </div>
                    <div class="p-4 rounded-xl bg-gray-50 border border-gray-100">
                        <p class="text-xs text-gray-500 mb-1"><?php echo e(__('Member Since')); ?></p>
                        <p class="text-sm font-semibold text-gray-900"><?php echo e($user->created_at->format('d M Y')); ?></p>
                    </div>
                    <div class="p-4 rounded-xl bg-gray-50 border border-gray-100">
                        <p class="text-xs text-gray-500 mb-1"><?php echo e(__('Email Status')); ?></p>
                        <p class="text-sm font-semibold flex items-center gap-1.5 <?php echo e($user->email_verified_at ? 'text-green-700' : 'text-amber-600'); ?>">
            ...
            <div class="mt-8 pt-6 border-t border-red-200">
                ...
                <div class="p-4 rounded-xl border border-red-200 bg-red-50/50">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div>
                            <p class="text-sm font-medium text-red-800"><?php echo e(__('Delete Account')); ?></p>
                            <p class="text-xs text-red-600 mt-0.5"><?php echo e(__('Once you delete your account, all data will be permanently removed. This action cannot be undone.')); ?></p>
                        </div>
...
<div id="delete-modal" class="<?php echo e($errors->userDeletion->isNotEmpty() ? '' : 'hidden'); ?> fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 animate-slide-in">
        <div class="text-center mb-4">
            ...
            <h3 class="text-lg font-bold text-gray-900"><?php echo e(__('Delete Account')); ?></h3>
            <p class="text-sm text-gray-500 mt-1"><?php echo e(__('Once you delete your account, all data will be permanently removed. This action cannot be undone.')); ?></p>
        </div>
        <form method="POST" action="<?php echo e(route('profile.destroy')); ?>">
            <?php echo csrf_field(); ?>
            <?php echo method_field('DELETE'); ?>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1.5"><?php echo e(__('Enter your password to confirm')); ?></label>
                <input type="password" name="password" required class="w-full px-4 py-2.5 border <?php echo e($errors->userDeletion->has('password') ? 'border-red-500 bg-red-50/50' : 'border-gray-300'); ?> rounded-xl focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition text-sm" placeholder="••••••••">
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\!Telkom\Semester 6\Proyek Perangkat Lunak\SI4705-KELA-main\greennovate\resources\views/profile/edit.blade.php ENDPATH**/ ?>