...
<div class="grid grid-cols-2 md:grid-cols-4 gap-5 mb-8">
    ...
    <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex flex-col gap-3">
        ...
        <div>
            <div class="text-2xl font-extrabold text-gray-900"><?php echo e($stats['total_users']); ?></div>
            <div class="text-xs text-gray-400 mt-0.5">Total Pengguna</div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex flex-col gap-3">
        ...
        <div>
            <div class="text-2xl font-extrabold text-gray-900"><?php echo e($stats['total_petugas']); ?></div>
    ...
    <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex flex-col gap-3">
        ...
        <div>
            <div class="text-2xl font-extrabold text-gray-900"><?php echo e($stats['total_aktif']); ?></div>
            <div class="text-xs text-gray-400 mt-0.5">Akun Aktif</div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex flex-col gap-3">
        ...
        <div>
            <div class="text-2xl font-extrabold text-gray-900"><?php echo e($stats['total_nonaktif']); ?></div>
            <div class="text-xs text-gray-400 mt-0.5">Akun Nonaktif</div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\!Telkom\Semester 6\Proyek Perangkat Lunak\SI4705-KELA-main\greennovate\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>