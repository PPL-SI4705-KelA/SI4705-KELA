...
class ChatController extends Controller
{
    public function index()
    {
        ...
        // Pre-load existing messages so the chat can be rendered immediately
        // on page load instead of waiting for the first AJAX poll to finish.
        $messages = $conversation
            ? $conversation->messages()->with('sender')->orderBy('created_at', 'asc')->get()
            : collect();
