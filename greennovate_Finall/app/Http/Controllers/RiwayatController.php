        ...
        switch ($tipe) {
            case 'donasi':
                ...
                $data = [
                    ...
                    'o2_contribution' => ($record->status === 'Sukses' && in_array($record->kegiatan?->tipe_kegiatan, ['tanam_pohon', 'beli_pohon']))
                                            ? number_format(($record->jumlah / ($record->kegiatan?->target_dana ?: 1)) * ($record->kegiatan?->estimasi_pohon ?: 0) * 8.3, 2)
                                            : null,
                    'has_qr'          => false,
                    'qr_url'          => null,
            ...
            case 'pembelian':
                ...
                $data = [
                    ...
                    'catatan'         => $record->catatan,
                    'o2_contribution' => ($record->status === 'Sukses') ? number_format((float)($pohon_tertanam) * 8.3, 2) : null,
