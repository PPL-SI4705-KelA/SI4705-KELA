        ...
        <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 navbar-glass transition-all duration-300">
            <div class="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    @else
                        {{-- Donasi --}}
                        <a href="{{ route('donations.index') }}" id="nav-donasi-link"
                           class="flex items-center gap-1.5 text-sm font-medium {{ request()->routeIs('donations.*') ? 'text-[#0D8B41] font-semibold' : 'text-gray-500 hover:text-[#0D8B41]' }} transition-colors px-2 py-1.5">
