                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                @if($d->bukti_dokumentasi)
                                    <button type="button" onclick="openImageModal('{{ asset('storage/' . $d->bukti_dokumentasi) }}')" class="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium text-[#0D8B41] bg-green-50 rounded-lg hover:bg-green-100 transition-colors border border-green-200">
