        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
            ...
            <a href="{{ route('admin.chat.index') }}"
               class="sidebar-link {{ request()->routeIs('admin.chat.*') ? 'active' : '' }}">
                ...
                @php
                    $unreadChatCount = \App\Models\Message::whereRaw('is_read = false')
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="{{ route('notifikasi.index') }}" class="relative text-gray-500 hover:text-black">
                    ...
                    @if($unreadNotifCount > 0)
                        <span class="notif-badge-count absolute -top-1.5 -right-1.5 bg-red-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full border-2 border-white">
                            {{ $unreadNotifCount }}
                        </span>
                    @else
                        <span class="notif-badge-count absolute -top-1.5 -right-1.5 bg-red-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full border-2 border-white" style="display: none;">
                            0
                        </span>
                    @endif
                </a>
