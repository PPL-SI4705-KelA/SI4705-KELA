    ...
    <aside class="w-56 min-h-screen bg-white border-r border-gray-200 flex flex-col fixed top-0 left-0 z-30">
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
            ...
            <a href="{{ route('admin.kegiatan.index') }}"
               class="sidebar-link {{ request()->routeIs('admin.kegiatan.*') && !request()->routeIs('admin.kegiatan.peserta') ? 'active' : '' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('admin.peserta.index') }}"
               class="sidebar-link {{ request()->routeIs('admin.peserta.index') || request()->routeIs('admin.kegiatan.peserta') ? 'active' : '' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('admin.donasi.index') }}"
               class="sidebar-link {{ request()->routeIs('admin.donasi.*') ? 'active' : '' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('admin.pembelian.index') }}"
               class="sidebar-link {{ request()->routeIs('admin.pembelian.*') ? 'active' : '' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            {{-- Inbox Notifikasi Admin --}}
            @php $adminInboxCount = \App\Models\Notifikasi::where('user_id', Auth::id())->belumDibaca()->count(); @endphp
            <a href="{{ route('admin.inbox') }}"
               class="sidebar-link {{ request()->routeIs('admin.inbox*') ? 'active' : '' }}" style="position:relative">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0H4m8-4v4m0 0l-3-3m3 3l3-3"/>
                </svg>
                Inbox
                @if($adminInboxCount > 0)
                    <span id="admin-notif-badge-sidebar"
            ...
            <a href="{{ route('admin.qrcode.index') }}"
               class="sidebar-link {{ request()->routeIs('admin.qrcode.*') ? 'active' : '' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="flex-1 ml-56 flex flex-col min-h-screen">
        ...
        <header class="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between sticky top-0 z-20">
            ...
            <div class="flex items-center gap-4">
                ...
                <!-- Inbox Notifikasi Admin (Topbar) -->
                @php $unreadNotifCount = \App\Models\Notifikasi::where('user_id', Auth::id())->belumDibaca()->count(); @endphp
                <a href="{{ route('admin.inbox') }}" class="relative text-gray-500 hover:text-[#0D8B41] transition" title="Inbox Notifikasi">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0H4"/>
                    </svg>
                    @if($unreadNotifCount > 0)
                        <span id="admin-notif-badge-topbar"
