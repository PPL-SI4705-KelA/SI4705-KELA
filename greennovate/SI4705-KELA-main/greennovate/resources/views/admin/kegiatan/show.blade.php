...
<div class="w-full max-w-2xl px-6 mt-8 mb-16">
    ...
    <div class="mb-6">
        <a href="{{ route('admin.kegiatan.index') }}" class="text-sm text-gray-400 hover:text-gray-600 mb-2 inline-block">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-4">
        <div class="grid grid-cols-2 gap-4 text-sm">
            <div>
                <p class="text-xs text-gray-400 uppercase font-semibold mb-0.5">Petugas</p>
                <p class="text-gray-800">{{ $kegiatan->petugas?->name ?? '-' }}</p>
            </div>
            <div>
                <p class="text-xs text-gray-400 uppercase font-semibold mb-0.5">Lokasi Lahan</p>
                <p class="text-gray-800">{{ $kegiatan->lokasLahan?->nama ?? '-' }}</p>
            </div>
            <div>
            ...
            <div>
                <p class="text-xs text-gray-400 uppercase font-semibold mb-0.5">Target Pohon</p>
                <p class="text-gray-800">{{ number_format($kegiatan->target_pohon) }} pohon</p>
            </div>
            <div>
                <p class="text-xs text-gray-400 uppercase font-semibold mb-0.5">Realisasi Pohon</p>
                <p class="text-gray-800">{{ number_format($kegiatan->realisasi_pohon) }} pohon</p>
            </div>
        </div>
