<?php $__env->startSection('title', 'Daftar - Greennovate'); ?>
...
<div class="w-full max-w-sm px-6 mb-12">
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
        ...
        <div>
            ...
            <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-1 focus:ring-green-600 focus:border-green-600 outline-none transition text-sm">
        </div>

        
        <div>
            <label for="login" class="block text-sm font-medium text-gray-700 mb-1">Email atau No HP</label>
            <input id="login" type="text" name="login" value="<?php echo e(old('login')); ?>" required placeholder="nama@email.com / 0812xxxx" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-1 focus:ring-green-600 focus:border-green-600 outline-none transition text-sm">
        </div>
        ...
        <div class="text-center text-sm text-gray-500 mt-6">
            Sudah punya akun? 
            <a href="<?php echo e(route('login')); ?>" class="text-green-600 font-medium hover:underline">Masuk</a>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PPL-SI4705-KelA\greennovate\SI4705-KELA-main\greennovate\resources\views/auth/register.blade.php ENDPATH**/ ?>