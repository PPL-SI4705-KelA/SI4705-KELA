    ...
    <div class="min-h-screen flex flex-col pt-12 items-center">
        ...
        <header class="w-full max-w-5xl px-6 flex justify-between items-center mb-16">
            ...
            <nav class="hidden md:flex gap-6 text-sm text-gray-500 font-medium">
                <a href="/" class="hover:text-black"><?php echo e(__('Beranda')); ?></a>
                <a href="#" class="hover:text-black"><?php echo e(__('Kegiatan')); ?></a>
...
</html><?php /**PATH C:\Users\LENOVO\Documents\GitHub\SI4705-KELA\greennovate\resources\views/layouts/auth.blade.php ENDPATH**/ ?>