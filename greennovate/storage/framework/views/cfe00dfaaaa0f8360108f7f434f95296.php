            ...
            <header class="w-full max-w-5xl px-6 flex justify-between items-center mb-16">
                ...
                <div class="flex items-center gap-4 text-sm font-medium">
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-gray-500 hover:text-black">Masuk</a>
                        <a href="<?php echo e(route('register')); ?>" class="bg-[#1b7b43] text-white px-4 py-2 rounded-full hover:bg-green-700 transition">Ikut Kegiatan</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="text-gray-500 hover:text-black">Dashboard</a>
...
<?php /**PATH C:\Users\Admin\Documents\GitHub\SI4705-KELA\greennovate\resources\views/layouts/auth.blade.php ENDPATH**/ ?>