...
<div class="w-full max-w-4xl px-6 mt-12">
    ...
    <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
        ...
        <p class="text-gray-500 mb-8">Selamat datang kembali, <span class="font-semibold text-gray-800"><?php echo e(Auth::user()->name); ?></span>!</p>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PPL-SI4705-KelA\greennovate\SI4705-KELA-main\greennovate\resources\views/user/dashboard.blade.php ENDPATH**/ ?>