                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open"
                            ...
                            <a href="<?php echo e(route('chat.index')); ?>"
                                ...
                                <span><?php echo e(__('Hubungi Admin')); ?></span>
                                <?php if(isset($unreadChatCount) && $unreadChatCount > 0): ?>
...
</html><?php /**PATH C:\PPL-SI4705-KelA\greennovate\SI4705-KELA-main\greennovate\resources\views/layouts/auth.blade.php ENDPATH**/ ?>