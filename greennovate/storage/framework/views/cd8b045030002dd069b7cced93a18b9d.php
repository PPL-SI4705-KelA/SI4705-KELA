        ...
        <?php $__empty_1 = true; $__currentLoopData = $kegiatanAktif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kegiatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="bg-white border rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-300 <?php echo e($isLowProgress ? 'border-orange-200' : 'border-gray-100'); ?>"
                ...
                <div class="flex gap-3">
                    <button onclick="openRealisasiModal(<?php echo e($kegiatan->id); ?>, '<?php echo e(addslashes($kegiatan->nama)); ?>', '<?php echo e(addslashes($kegiatan->lokasiLahan?->alamat ?? '-')); ?>')"
                    ...
                    <button
                        type="button"
                        onclick='openDokumentasiModal(<?php echo e($kegiatan->id); ?>, <?php echo json_encode($kegiatan->nama, 15, 512) ?>)'
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.petugas', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PPL-SI4705-KelA\greennovate\SI4705-KELA-main\greennovate\resources\views/petugas/dashboard.blade.php ENDPATH**/ ?>