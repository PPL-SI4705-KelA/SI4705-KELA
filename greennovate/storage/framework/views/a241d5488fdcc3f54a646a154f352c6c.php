...
<div class="w-full max-w-4xl px-6 mt-12">
    ...
    <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
        ...
        <p class="text-gray-500 mb-8">Selamat datang kembali, <?php echo e(Auth::user()->name); ?>!</p>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/awangwahyu/Documents/GitHub/SI4705-KELA/greennovate/resources/views/dashboard.blade.php ENDPATH**/ ?>