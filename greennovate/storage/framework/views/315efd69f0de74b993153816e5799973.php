...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin – Greennovate'); ?></title>
...
<body class="bg-gray-100 min-h-screen flex">
    ...
    <aside class="w-56 min-h-screen bg-white border-r border-gray-200 flex flex-col fixed top-0 left-0 z-30">
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
            ...
            <a href="<?php echo e(route('admin.kegiatan.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admin.kegiatan.*') && !request()->routeIs('admin.kegiatan.peserta') ? 'active' : ''); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('admin.jenis-pohon.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admin.jenis-pohon.*') ? 'active' : ''); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('admin.peserta.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admin.peserta.index') || request()->routeIs('admin.kegiatan.peserta') ? 'active' : ''); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('admin.donasi.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admin.donasi.*') ? 'active' : ''); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('admin.pembelian.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admin.pembelian.*') ? 'active' : ''); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('admin.pengguna.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admin.pengguna.*') ? 'active' : ''); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('admin.chat.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admin.chat.*') ? 'active' : ''); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="px-3 py-4 border-t border-gray-100">
            <div class="flex items-center gap-2.5 mb-2 px-1">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-gray-400 truncate"><?php echo e(Auth::user()->email ?? Auth::user()->phone); ?></p>
                </div>
            </div>
    ...
    <div class="flex-1 ml-56 flex flex-col min-h-screen">
        ...
        <header class="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between sticky top-0 z-20">
            <div>
                <h1 class="text-lg font-bold text-gray-900"><?php echo $__env->yieldContent('page-title', 'Admin'); ?></h1>
                <p class="text-xs text-gray-400"><?php echo $__env->yieldContent('page-subtitle', ''); ?></p>
            </div>
...
<?php /**PATH C:\Users\egiag\Downloads\Gabungan\greennovate_final\resources\views/layouts/admin.blade.php ENDPATH**/ ?>