...
<body class="text-gray-800 antialiased">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="{{ route('petugas.semua-kegiatan') }}" class="menu-item {{ request()->routeIs('petugas.semua-kegiatan') ? 'active' : '' }}">
                <svg class="w-[18px] h-[18px] {{ request()->routeIs('petugas.semua-kegiatan') ? 'text-white' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="sidebar-footer">
            <div class="profile-card">
                ...
                <div class="overflow-hidden">
                    <div class="font-bold text-sm text-gray-900 truncate">{{ auth()->user()->name ?? 'Petugas' }}</div>
    ...
    <div class="main-wrapper">
        ...
        <header class="top-header">
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-[17px] font-bold text-gray-800">@yield('header', 'Kegiatan Saya')</h1>
            </div>
