        ...
        <div class="flex items-center gap-4 text-sm font-medium">
            @guest
                ...
                <a href="{{ route('register') }}"
                   class="bg-[#1b7b43] text-white px-4 py-2 rounded-full hover:bg-green-700">
                    {{ __('Join Activity') }}
                </a>
            @else
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <button @click="open = !open"
                            class="w-10 h-10 rounded-full bg-[#1b7b43] flex items-center justify-center text-white font-bold">
