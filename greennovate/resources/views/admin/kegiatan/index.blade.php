    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm mb-4">
        <form method="GET" action="{{ route('admin.kegiatan.index') }}"
            ...
            <div class="flex-1 min-w-[180px]">
                <label class="block text-xs font-medium text-gray-500 mb-1">Cari nama / lokasi</label>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        <th class="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Nama Kegiatan</th>
                        ...
                        <th class="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Target</th>
                        <th class="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Kuota</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3 text-gray-600">{{ $kegiatan->lokasi }}</td>
                        <td class="px-4 py-3 text-gray-600">
                            {{ $kegiatan->tanggal->format('d M Y') }}
                        </td>
                        <td class="px-4 py-3 text-gray-600">{{ number_format($kegiatan->target) }}</td>
                        <td class="px-4 py-3 text-gray-600">{{ number_format($kegiatan->kuota) }}</td>
                        <td class="px-4 py-3">
                            @php
