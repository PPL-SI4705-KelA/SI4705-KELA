    ...
    <form method="GET"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="flex items-end gap-2">
                ...
                <button type="submit"
                        class="flex-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-2.5 px-4 rounded-lg text-sm transition-colors duration-200">
                    Cari
                </button>
    ...
    @if($kegiatan->total() > 0)
        <p class="text-sm text-gray-400 mb-5">
            ...
            <span class="font-semibold text-gray-600">
                {{ $kegiatan->firstItem() }}–{{ $kegiatan->lastItem() }}
            </span>
            dari
            <span class="font-semibold text-gray-600">
                {{ $kegiatan->total() }}
                    ...
                    <div class="relative h-44 overflow-hidden bg-gradient-to-br from-green-400 to-emerald-600">
                        ...
                        @else
                            ...
                            <div class="absolute inset-0 flex items-center justify-center">
                                <svg class="w-16 h-16 text-white/40"
                                     fill="none"
                                     stroke="currentColor"
                                     viewBox="0 0 24 24">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex items-center gap-2 text-sm text-gray-500 mb-4">
                            ...
                            <span class="font-medium text-gray-700">
                                {{ number_format($item->target_pohon) }} pohon
                            </span>
                        </div>
