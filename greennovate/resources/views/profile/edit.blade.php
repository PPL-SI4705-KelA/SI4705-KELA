    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="border-b border-gray-200 bg-gray-50/60">
            <nav class="flex" id="tab-nav">
                ...
                <button type="button" onclick="switchTab('achievements')" id="tab-btn-achievements"
                    class="tab-btn relative px-6 py-4 text-sm font-medium text-gray-500 hover:text-gray-700 transition-colors flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        {{-- TAB 4: PENCAPAIAN O2 --}}
        {{-- ============================================== --}}
        <div id="tab-achievements" class="tab-content p-6 md:p-8 hidden">
            <div class="mb-6">
                <h2 class="text-xl font-bold text-gray-900">Pencapaian O2 Anda</h2>
            ...
            @if($nextBadge)
            <div class="bg-white border-2 border-gray-100 rounded-2xl p-6 mb-8 shadow-sm">
            ...
            @else
            <div class="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-2xl p-6 mb-8 text-center shadow-sm">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                        ...
                        <div class="relative z-10">
                            ...
                            <p class="text-xs text-gray-500 mt-1 line-clamp-2" title="{{ $ua->achievement->pesan_dampak }}">{{ $ua->achievement->pesan_dampak }}</p>
                            <p class="text-[10px] font-semibold text-gray-400 mt-3 uppercase">Diraih pada {{ $ua->created_at->format('d M Y') }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>
